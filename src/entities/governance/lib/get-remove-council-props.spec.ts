...
import {ChangePolicyProposalFormFields} from '../governance';

describe('Change quorum props', () => {
  test('return right args', () => {
    const currentDao = {
      isArchived: false,
    ...
    expect(getChangeQuorumProps(currentDao, formData).args).toEqual({
      proposal: {
        description: 'change 10$$$$$$$$ProposeUpdateGroup',
        kind: {
          ChangePolicy: {
            policy: {
              ...
              default_vote_policy: {quorum: '0', threshold: [1, 2], weight_kind: 'RoleWeight'},
